...
/*
$__smtp = array(
    "host" => 'mail.stupeni-a.com.ua', // SMTP сервер
    "debug" => 2, // Уровень логирования
    "auth" => true, // Авторизация на сервере SMTP. Если ее нет - false
    "port" => '25', // Порт SMTP сервера
    "username" => 'admin@stupeni-a.com.ua', // Логин запрашиваемый при авторизации на SMTP сервере
    "password" => 'creator76', // Пароль
    "addreply" => 'aelitapro@ukr.net', // Почта для ответа
    "secure" => 'ssl', // Тип шифрования. Например ssl или tls
