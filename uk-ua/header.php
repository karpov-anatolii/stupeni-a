...
if (!$meta_rights) $meta_rights = "Сходи-А";
?>
...
<head>
  ...
  <title><?php echo $meta_title ?> від Сходи-А</title>
    ...
    <header id="header">
      ...
      <div style="width:100%;height: 6px;">
        <div style=" visibility:hidden; float:left;">
          <img class="img-logo" src="/static/images2/logo_ua_710x185.jpg" alt="Ступени-А" style="position: absolute; max-width:150px;">
        </div>
        ...
        <div class="div-multy-lang">
          <a style="color:#eee;font-family: 'Ubuntu', sans-serif;" href="https://stupeni-a.com.ua/uk-ua<?php echo str_replace('/uk-ua', '', $_SERVER['REQUEST_URI']) ?>">UA</a>
          <span>&nbsp;|&nbsp; </span>
          <a style="color:#eee;font-family: 'Ubuntu', sans-serif;" href="https://stupeni-a.com.ua<?php echo str_replace('/uk-ua', '', $_SERVER['REQUEST_URI']) ?>">RU</a>
          <span>&nbsp;|&nbsp; </span>
          <a style="color:#eee;font-family: 'Ubuntu', sans-serif;" href="https://stupeni-a.com.ua/en<?php echo str_replace('/uk-ua', '', $_SERVER['REQUEST_URI']) ?>">EN</a>
        </div>
      ...
      <div class="header-content clearfix"> <a href="/uk-ua/index.php"><img class="img-logo" src="/static/images2/logo_ua_333x43.png" alt="Ступени-А" style="margin: -11px 0 0 0px;"></a>
        <nav class="navigation" role="navigation">
          <ul class="primary-nav" style="margin: -10px 0 10px 0;">
            <li><a href="/uk-ua/index.php">Головна</a></li>
            <li><a href="/uk-ua/arhitekturnyj-mramor-beton.php">Мармур-Бетон</a></li>
            <li><a href="/uk-ua/portfolio.php">Фотогалерея</a></li>
            <li><a href="/uk-ua/posts.php">Статті</a></li>
            <li><a href="/uk-ua/cena.php">Ціна</a></li>

          </ul>
          <ul class="primary-nav">
            <li><a href="/uk-ua/comments.php">Відгуки</a></li>
            <li><a href="/uk-ua/betonnyie-perila.php">Бетонні перила</a></li>
            <li><a href="/uk-ua/betonnyie-poruchni.php">Бетонні поручні</a></li>
            <li><a href="/uk-ua/chasto-zadavaemye-voprosy.php">FAQs</a></li>
            <li><a href="/uk-ua/contact.php">Контакти</a></li>
