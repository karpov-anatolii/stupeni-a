	...
	<div class="footer-bottom">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 col-xs-12" style="padding: 30px 0 30px 0px;">
					<!-- <h5 style="letter-spacing: 2px !important;">Бетонные лестницы: (+38)067-409-40-85, (+38)050-981-67-70 </h5> -->
					<h4 style="letter-spacing: 2px !important;">&#128222; (+38)096-933-63-33 </h4>
				</div><br>
				<div class="col-md-12" style="width:100%">
					<h3 class="footer-h3" style="  text-transform:none; letter-spacing:8px;">Ступени-А</h3>
				</div>


				<div class="col-md-12" style="color:#4b4b4b;margin-bottom: 20px;">
					<h6>© 2011 - <?php echo date('Y') ?> Ступени-А. &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Все права защищены. </h6>
				</div>
				...
				<div class="counter-liv" style="width:100%;float:left;font-size: 12px;margin-bottom: 20px;">
					...
					echo ("<div align=\"center\"><span class=\"counter\">Всего посещений - " . $counts[3] . " | Всего за день - " . $counts[2] . " | Уникальных за день - " . $counts[1] . " | Сейчас на сайте: - " . sizeof(file($base)) . "</span></div>");
...
<script type="text/javascript">
	...
	var h2text = [
		'<a href="/arhitekturnyj-mramor-beton.php"  target="_blank" rel="noopener" >Архитектурный Мрамор-Бетон собственного производства</a>',
		'Креативная команда дизайнеров и инженеров',
		'Инженерный расчет в ЛИРА-САПР с полным комплектом чертежей',
		'Индивидуальный подход и гарантия качества',
		'Инновационные технологии для производства бетонных перил',
		'Огромный производственный опыт с 2011 года'
