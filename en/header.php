...
$sites = array(
  ...
  "en" => "https://stupeni-a.com.ua/en-gb" . $_SERVER['REQUEST_URI'],
);
// получаем язык
...
if (!$meta_rights) $meta_rights = "Stairs-A";
?>
...
<head>
  ...
  <title><?php echo $meta_title ?> from Stairs-A</title>
  ...
  <?php if ($alternate_hreflang) echo  '<link rel="alternate" hreflang="ru" href="' . $alternate_hreflang . '" />'; ?>
    ...
    <header id="header">
      ...
      <div style="width:100%;height: 6px;">
        <div style=" visibility:hidden; float:left;">
          <img class="img-logo" src="/static/images2/logo_ua_710x185.jpg" alt="Stairs-A" style="position: absolute; max-width:150px;">
        </div>
        ...
        <div class="div-multy-lang">
          <a style="color:#eee;font-family: 'Ubuntu', sans-serif;" href="https://stupeni-a.com.ua/uk-ua<?php echo str_replace('/en', '', $_SERVER['REQUEST_URI']) ?>">UA</a>
          <span>&nbsp;|&nbsp; </span>
          <a style="color:#eee;font-family: 'Ubuntu', sans-serif;" href="https://stupeni-a.com.ua<?php echo str_replace('/en', '', $_SERVER['REQUEST_URI']) ?>">RU</a>
          <span>&nbsp;|&nbsp; </span>
          <a style="color:#eee;font-family: 'Ubuntu', sans-serif;" href="https://stupeni-a.com.ua/en<?php echo str_replace('/en', '', $_SERVER['REQUEST_URI']) ?>">EN</a>
        </div>
      ...
      <!-- navigation section  -->
      <!-- <div class="header-content clearfix">   <a href="/"><span class="logo">Сходи-А</span></a> -->
      <div class="header-content clearfix"> <a href="/en/index.php"><img class="img-logo" src="/static/images2/logo_en_317x45.png" alt="Stairs-A" style="margin: -11px 0 0 0px;"></a>
        <nav class="navigation" role="navigation">
          <ul class="primary-nav" style="margin: -10px 0 10px 0;">
            <li><a href="/en/index.php">Main</a></li>
            <li><a href="/en/arhitekturnyj-mramor-beton.php">Marble-Concrete</a></li>
            <li><a href="/en/portfolio.php">Photo gallery</a></li>
            <li><a href="/en/posts.php">Articles</a></li>
            <li><a href="/en/cena.php">Price</a></li>

          </ul>
          <ul class="primary-nav">
            <li><a href="/en/comments.php">Reviews</a></li>
            <li><a href="/en/betonnyie-perila.php">Concrete railings</a></li>
            <li><a href="/en/betonnyie-poruchni.php">Concrete handrails</a></li>
            <li><a href="/en/chasto-zadavaemye-voprosy.php">FAQs</a></li>
            <li><a href="/en/contact.php">Contacts</a></li>
