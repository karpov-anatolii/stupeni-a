	...
	<div class="footer-bottom">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 col-xs-12" style="padding: 30px 0 30px 0px;">
					<!-- <h5 style="letter-spacing: 2px !important;">Concrete stairs: (+38)067-409-40-85, (+38)050-981-67-70 </h5> -->
					<h5 style="letter-spacing: 2px !important;">&#128222; (+38)096-933-63-33 </h5>
				</div><br>
				<div class="col-md-12" style="width:100%">
					<h3 class="footer-h3" style=" text-transform:none; letter-spacing:2px;">Stairs-A</h3>
				</div>


				<div class="col-md-12" style="color:#4b4b4b;margin-bottom: 20px;">
					<h6>© 2011 - <?php echo date('Y') ?> Stairs-A. &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; All rights reserved. </h6>
				</div>
				...
				<div class="counter-liv" style="width:100%;float:left;font-size: 12px;margin-bottom: 20px;">
					...
					echo ("<div align=\"center\"><span class=\"counter\">Total views - " . $counts[3] . " | Just for a day - " . $counts[2] . " | Unique for the day - " . $counts[1] . " | Now on the site: - " . sizeof(file($base)) . "</span></div>");
...
<script type="text/javascript">
	...
	var h2text = [
		'<a href="arhitekturnyj-mramor-beton.php"  target="_blank" rel="noopener" >Architectural Marble-Concrete of our own production</a>',
		'Creative team of designers and engineers',
		'Engineering calculation in LIRA-CAD with a complete set of drawings',
		'Individual approach and quality guarantee',
		'Innovative technologies for the production of concrete railings',
		'Huge production experience since 2011'
